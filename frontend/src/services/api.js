...
// Use Vite proxy for local development, /_backend for Vercel production
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || (import.meta.env.MODE === 'production' ? '/_backend/api' : '/api'),
